...
<ol class="breadcrumb ">
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST" name="form11" onsubmit="return validateForm()">
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" name="supplier"  class="form-control" onkeyup="myFunction()" id="some" required>
          </div>
          <div class="form-group">
            <label for="some" class="col-form-label">Medicine Company Name</label>
            <input type="text" name="company" onkeyup="myFunction()" class="form-control" id="some" required>
          </div>
          <div class="form-group">
...
<script >
  ...
  // var letters = /^[A-Za-z]+$/;
  //  if(document.getElementById("some").value.match(letters) || document.getElementById("some").value.match(letters))
  //    {
  //          // alert("messagdwdae");
  //          return true;
...
function validateForm() {
    ...
    if (!document.getElementById("name").value.match(letters) ) {
        alert(document.getElementById("name").value);
        alert("Enter alphabet only in the Name Field !!");
        return false;
    } else {
        alert("Namdsd");
    }
